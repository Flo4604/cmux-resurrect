...
var (
	...
	shellFlameStyle      = lipgloss.NewStyle().Foreground(lipgloss.AdaptiveColor{Dark: "#FFB454", Light: "#D4820A"})
	...
	shellCompletionStyle = lipgloss.NewStyle().Foreground(lipgloss.AdaptiveColor{Dark: "#6C6C6C", Light: "#9C9C9C"})
)
